...
define build.itch_project = "cut"

## 带有 _() 的字符串表示其可被翻译。

define config.name = _("剪烛西窗")
...
define config.sample_sound = "audio/door_beep.mp3"
##define config.sample_voice = "audio/MusMus-BGM-139.mp3"


## 将以下语句取消注释就可以设置标题界面播放的背景音乐文件。此文件将在整个游戏中
## 持续播放，直至音乐停止或其他文件开始播放。

define config.main_menu_music = "audio/autumn_night.mp3"
...
define circirisout = ImageDissolve("images/008.png", .2)
define circirisin = ImageDissolve("images/160.png", .2)


define config.enter_transition = circirisout
define config.exit_transition = circirisout


## 各个游戏菜单之间的转场。


define config.intra_transition = circirisin
...
define config.save_directory = "QM-1653132091"
